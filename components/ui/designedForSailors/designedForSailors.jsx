      ...
      try {
        const response = await fetch(
          process.env.NODE_ENV === "development"
            ? `${process.env.NEXT_PUBLIC_DEV_URL}/api/contact/designed-for-sailors`
            : `${process.env.NEXT_PUBLIC_PUBLIC_URL}/api/contact/designed-for-sailors`,
          {
            method: "POST",
            headers: {
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <div className="mx-auto max-w-[700px] text-gray-500 md:text-xl ">
            ...
            <Image
              ...
              height="600"
              src="/images/designedForSailors/CDI-SunsetSail.jpg"
              width="1200"
            />
          </div>
        </section>
            ...
            <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12 xl:grid-cols-2">
              ...
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  <Link
                    className="inline-flex h-10 items-center justify-center rounded-md border border-gray-200 text-gray-50 bg-[#145DA0] px-8 text-sm font-medium shadow-sm transition-colors hover:bg-[#B1D4E0] hover:text-black focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 "
                    href="/designed-for-sailors#find-your-furler"
                  >
                    Find your Furler
                  </Link>
