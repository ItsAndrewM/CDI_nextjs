      ...
      try {
        const response = await fetch(
          process.env.NODE_ENV === "development"
            ? `${process.env.NEXT_PUBLIC_DEV_URL}/api/contact/contact-us`
            : `${process.env.NEXT_PUBLIC_PUBLIC_URL}/api/contact/contact-us`,
          {
            method: "POST",
            headers: {
  ...
  return (
    <div className="relative">
      <main className="flex flex-col items-center justify-center space-y-8 p-4 md:p-8">
        ...
        <div className="grid gap-4 w-full max-w-2xl lg:grid-cols-3 grid-cols-2">
